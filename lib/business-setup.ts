export function resolveSetupRoute(route?: string | null) {
  ...
  if (["/settings/business/whatsapp", "/settings/business/profile", "/settings/business/services", "/settings/business/availability", "/settings/business/policies"].includes(route)) return { href: route, available: true };
